(function() {
  ...
  const STORAGE_KEY = 'adniamey2000_lang';
  const CACHE_KEY = 'adniamey2000_translations';
  ...
  function loadTranslations(lang) {
    ...
    script.src = './data/' + lang + '.js?_v=' + Date.now();
    script.onload = function() {
      if (window._tr && window._tr[lang]) {
        translations = window._tr[lang];
