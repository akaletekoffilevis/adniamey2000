...
module.exports = async function (fastify) {
  ...
  // --- TESTIMONIALS ---
  fastify.get('/api/admin/testimonials', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
    return db.prepare('SELECT * FROM testimonials ORDER BY sort_order ASC, id ASC').all();
  });
  fastify.post('/api/admin/testimonials', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
  ...
  fastify.put('/api/admin/testimonials/:id', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
    var data = fillAllLangs(req.body);
  ...
  fastify.delete('/api/admin/testimonials/:id', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
  ...
  // --- SCHEDULES ---
  fastify.get('/api/admin/schedules', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
    return db.prepare('SELECT * FROM schedules ORDER BY sort_order ASC, id ASC').all();
  });
  fastify.post('/api/admin/schedules', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
    var data = fillAllLangs(req.body);
  ...
  fastify.put('/api/admin/schedules/:id', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
    var data = fillAllLangs(req.body);
    data.id = req.params.id;
  ...
  fastify.delete('/api/admin/schedules/:id', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
  ...
  // --- MINISTRIES ---
  fastify.get('/api/admin/ministries', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
    return db.prepare('SELECT * FROM ministries ORDER BY sort_order ASC, id ASC').all();
  });
  fastify.post('/api/admin/ministries', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
    var data = fillAllLangs(req.body);
  ...
  fastify.put('/api/admin/ministries/:id', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
    var data = fillAllLangs(req.body);
    data.id = req.params.id;
  ...
  fastify.delete('/api/admin/ministries/:id', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
  ...
  // --- DOCTRINE ---
  fastify.get('/api/admin/doctrine', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
    return db.prepare('SELECT * FROM doctrine ORDER BY sort_order ASC, id ASC').all();
  });
  fastify.post('/api/admin/doctrine', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
    var data = fillAllLangs(req.body);
  ...
  fastify.put('/api/admin/doctrine/:id', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
    var data = fillAllLangs(req.body);
    data.id = req.params.id;
  ...
  fastify.delete('/api/admin/doctrine/:id', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
  ...
  // --- HISTORY ---
  fastify.get('/api/admin/history', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
    return db.prepare('SELECT * FROM history_blocks ORDER BY sort_order ASC, id ASC').all();
  });
  fastify.post('/api/admin/history', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
    var data = fillAllLangs(req.body);
  ...
  fastify.put('/api/admin/history/:id', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
    var data = fillAllLangs(req.body);
    data.id = req.params.id;
  ...
  fastify.delete('/api/admin/history/:id', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
  ...
  // --- STATS ---
  fastify.get('/api/admin/stats', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
    return db.prepare('SELECT * FROM site_stats ORDER BY sort_order ASC, id ASC').all();
  });
  fastify.post('/api/admin/stats', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
    var data = fillAllLangs(req.body);
  ...
  fastify.put('/api/admin/stats/:id', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
    var data = fillAllLangs(req.body);
    data.id = req.params.id;
  ...
  fastify.delete('/api/admin/stats/:id', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
  ...
  // --- CONTACT DETAILS ---
  fastify.get('/api/admin/contacts', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
    return db.prepare('SELECT * FROM contact_details ORDER BY sort_order ASC, id ASC').all();
  });
  fastify.post('/api/admin/contacts', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
    var data = fillAllLangs(req.body);
  ...
  fastify.put('/api/admin/contacts/:id', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
    var data = fillAllLangs(req.body);
    data.id = req.params.id;
  ...
  fastify.delete('/api/admin/contacts/:id', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
  ...
  // --- SOCIAL LINKS ---
  fastify.get('/api/admin/social', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
    return db.prepare('SELECT * FROM social_links ORDER BY sort_order ASC, id ASC').all();
  });
  fastify.post('/api/admin/social', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
    var data = req.body;
  ...
  fastify.put('/api/admin/social/:id', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
    var data = req.body;
    data.id = req.params.id;
  ...
  fastify.delete('/api/admin/social/:id', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
  ...
  // --- DONATION METHODS ---
  fastify.get('/api/admin/donations', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
    return db.prepare('SELECT * FROM donation_methods ORDER BY sort_order ASC, id ASC').all();
  });
  fastify.post('/api/admin/donations', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
    var data = req.body;
  ...
  fastify.put('/api/admin/donations/:id', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
    var data = req.body;
    data.id = req.params.id;
  ...
  fastify.delete('/api/admin/donations/:id', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
  ...
  for (var i = 0; i < getById.length; i++) {
    (function(cfg) {
      fastify.get('/api/admin/' + cfg.route + '/:id', { preHandler: [authMiddleware], schema: { tags: ['Admin'] } }, async (req, reply) => {
