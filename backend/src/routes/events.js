...
module.exports = async function(fastify) {
  ...
  fastify.post('/api/events', { preHandler: [authMiddleware], schema: { body: eventBodySchema } }, async (req, reply) => {
  ...
  fastify.put('/api/events/:id', { preHandler: [authMiddleware], schema: { body: eventBodySchema } }, async (req, reply) => {
  ...
  fastify.delete('/api/events/:id', { preHandler: [authMiddleware] }, async (req, reply) => {
